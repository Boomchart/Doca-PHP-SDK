...
use DocaLib\Controllers;

/**
 * DocaLib client class
 */
class DocaClient implements ConfigurationInterface
{
    private $misc;
    ...
    private const ENVIRONMENT_MAP = [
        Environment::PRODUCTION => [
            Server::SERVER_1 => 'https://6a09-102-219-52-29.eu.ngrok.io/doca/api',
        ],
    ];
}
